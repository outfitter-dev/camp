 ...
 */
export const OxlintConfigSchema = z.object({
 ...
 */
export const CommitlintConfigSchema = z.object({
 ...
 */
export const StylelintConfigSchema = z.object({
 ...
 */
export const MarkdownlintConfigSchema = z.object({
