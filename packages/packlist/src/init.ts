 ...
 *
 * Configures recommended ESLint and TypeScript settings, installs necessary dependencies, and adds useful scripts to `package.json` according to the provided options. Exits the process if `package.json` is missing in the project root.
 *
