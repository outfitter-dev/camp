...
export const mockFn = isVitest ? vi.fn : isJest ? jest.fn : () => { throw new Error('No test runner detected'); };
export const spyOn = isVitest ? vi.spyOn : isJest ? jest.spyOn : () => { throw new Error('No test runner detected'); };
