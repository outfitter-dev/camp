...
/**
 * Imports or exports a fieldguide configuration file, depending on the specified action.
 *
 * For 'export', saves the current local fieldguide configuration (including legacy keys) to the given output file with metadata.
 ...
 * @param options - For 'export', specifies the output file path; for 'import', specifies the input file path.
 *
 * @remark
