 ...
 *
 * For 'export', saves the current local fieldguide configuration (including legacy keys and metadata) to the given output file.
 ...
 * @param options - Options for the chosen action, specifying the relevant file path.
 *
 * @remark
