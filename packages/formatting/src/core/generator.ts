...
import eslintConfigModule, { generate as generateEslintConfigFunc } from '@outfitter/eslint-config';
...
const generateEslintConfig: ConfigGenerator<{
  typescript?: boolean;
  react?: boolean;
  node?: boolean;
 ...
 */
function generateEslintConfigFile(preset: PresetConfig, yamlPreset?: YamlPreset): Result<GeneratedConfig, Error> {
  try {
